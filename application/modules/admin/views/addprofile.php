				...
				<div class="form-validation">
					<form class="form-valide" action="<?php echo base_url(); ?>admin/addingprofile" method="post">
						...
						<div class="form-group row">
							...
							<div class="col-lg-8">
								<input type="text" class="form-control input-focus" id="val-email" name="val-email" placeholder="Your valid email..">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							<label class="col-lg-2 col-form-label" for="val-select2">Select2 <span class="text-danger">*</span></label>
							<div class="col-lg-8">
